...
import {ChickenMenuData} from "../../components/JSONFormat/MenuListData/MenuListData"
    ...
    <>
      <section className="py-40 font-poppins ">
        <div className="container mx-auto px-5 sm:px-3 2xl:px-0">
          ...
          <h2 className="text-primary text-7xl font-dancing font-semibold text-center pt-20">Chicken</h2>
          <p className="text-center pb-20 pt-5 ">"From classic favorites to innovative dishes, our chicken menu has it all."</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {ChickenMenuData.map((chickenMenu)=>{
              const {id, img, title, price, alt} = chickenMenu
              return(
