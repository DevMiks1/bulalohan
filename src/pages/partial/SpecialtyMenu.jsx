...
import { SpecialMenuData } from "../../components/JSONFormat/MenuListData/MenuListData"
    ...
    <>
      <section className="py-40 font-poppins ">
        <div className="container mx-auto px-5 sm:px-3 2xl:px-0">
          ...
          <h2 className="text-primary text-7xl font-dancing pt-20 font-semibold text-center 2xl:text-[5rem] 2xl:leading-none">Specials</h2>
          <p className="text-center pb-20 pt-5 2xl:text-[1.5]">"Experience the magic of exceptional dining with our special culinary creations."</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {SpecialMenuData.map((specialMenu)=>{
              const {id, img, title, numbers, price , alt} = specialMenu
              return(
