...
import {NoodlesMenuData} from "../../components/JSONFormat/MenuListData/MenuListData"

export const NoodlesMenu = () => {
  return (
    <>
      <section className="py-40 font-poppins ">
        <div className="container mx-auto px-5 sm:px-3  2xl:px-0">
          ...
          <h2 className="text-primary text-7xl font-dancing font-semibold text-center pt-20">Noodles</h2>
          <p className="text-center pb-20 pt-5 ">"In the presence of noodles, silence is golden."</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {NoodlesMenuData.map((noodlesMenu)=>{
              const {id, img, title, price, alt} = noodlesMenu
              return(
