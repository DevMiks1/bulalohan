...
import {VegetableMenuData} from "../../components/JSONFormat/MenuListData/MenuListData"
    ...
    <>
      <section className="py-40 font-poppins ">
        <div className="container mx-auto px-5 sm:px-3 2xl:px-0">
          ...
          <h2 className="text-primary text-7xl font-dancing font-semibold text-center pt-20">Vegetables</h2>
          <p className="text-center pb-20 pt-5 ">"Vegetables are the most potent, life-giving foods on the planet."</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {VegetableMenuData.map((vegetableMenu)=>{
              const {id, img, title, price, alt} = vegetableMenu
              return(
                <div key={id} className="mx-auto border border-white dark:border w-[300px] flex flex-col rounded-lg overflow-hidden dark:bg-darkModeGray dark:border-darkModeGray lg:w-[330px] 2xl:w-[350px]" style={{boxShadow: "0 0 15px -5px rgba(0, 0, 0, 0.5)"}}>
                  <div >
                  ...
                  <div className="px-5 py-5">   
                    ...
                    <p className="text-[1.2rem] pb-5">{price}</p>
